COMPILER = g++
OFLAG = -O3
FLAGS = -m64 -g -fopenmp $(OFLAG) -I $(FFTW__HOME)/include -I$(EIGEN__HOME)/include
LINKS= -L$(FFTW__HOME)/lib -lfftw3l_threads -lfftw3l -lfftw3l_omp
...
gabe: g2header.h g2parameters.h g2model.o g2functions.o g2spectra.o g2output.o g2main.o g2init.o 
...
g2spectra.o: g2header.h g2parameters.h g2functions.cpp g2spectra.cpp
	$(COMPILER) -c $(FLAGS)  g2spectra.cpp

g2model.o: g2header.h g2parameters.h g2model.cpp g2functions.cpp
